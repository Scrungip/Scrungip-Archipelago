...
def get_location_datas(world: Optional[MultiWorld], player: Optional[int]):
    ...
    location_table: List[LocationData] = [
        LocationData("Main Caves", "Main Caves: Vertical Spike Room Upper",  8680000, 53, lambda state: logic.AM2R_can_fly(state) and logic.AM2R_can_bomb(state)),  # spider + bomb
        LocationData("Main Caves", "Main Caves: Vertical Spike Room Lower",  8680001, 52, logic.AM2R_can_bomb),  # bomb
        LocationData("Main Caves", "Main Caves: Crumble Spike Room",  8680002, 57, lambda state: state.has_any({'Hi Jump', 'Space Jump'}, player) and logic.AM2R_can_bomb(state)),  # jump. just jump. ibj and dbj can come later in advanced logic frogtroll
        LocationData("Main Caves", "Main Caves: Maze",  8680003, 210),
        LocationData("Main Caves", "Main Caves: Shinespark Before the drop",  8680004, 54, lambda state: state.has("Speed Booster", player)),  # speed
        LocationData("Main Caves", "Main Caves: Shinespark After the drop",  8680005, 55, lambda state: state.has("Speed Booster", player)),  # speed
        ...
        LocationData("Golden Temple", "Golden Temple: Puzzle Room 1",  8680014, 101),
        LocationData("Golden Temple", "Golden Temple: Puzzle Room 2",  8680015, 108),
        LocationData("Golden Temple", "Golden Temple: Puzzle Room 3",  8680016, 102),
        LocationData("Golden Temple", "Golden Temple: Spider Ball",  8680017, 2),
        LocationData("Golden Temple", "Golden Temple: Celling Missile",  8680018, 109, lambda state: state.has("Speed Booster", player) or logic.AM2R_can_spider(state)),  # canspider
        ...
        LocationData("Hydro Station", "Hydro Station: Morph Tunnel",  8680023, 152),
        ...
        LocationData("Hydro Station", "Hydro Station: Water puzzle Beside Varia",  8680026, 159, logic.AM2R_can_bomb),  # bomb
        ...
        LocationData("Inner Hydro Station", "Hydro Station: Dead End Missile ",  8680033, 155, logic.AM2R_can_bomb),
        ...
        LocationData("Industrial Complex", "Industrial Complex: Robot room in the Wall",  8680053, 208, lambda state: state.has("Speed Booster", player)),
        LocationData("Industrial Complex", "Industrial Complex: Robot room in the Floor", 8680054, 207, lambda state: state.has("Super Missile", player) and state.has("Speed Booster", player)),
        LocationData("Industrial Complex", "Industrial Complex: First Supers",  8680055, 206, lambda state: state.has("Super Missile", player) and state.has("Speed Booster", player)),
        ...
        LocationData("The Tower", "The Tower: Dark Maze",  8680063, 252, logic.AM2R_can_bomb),  # bomb
        LocationData("The Tower", "The Tower: Outside the Dark Maze",  8680064, 251, logic.AM2R_can_bomb),
        ...
        LocationData("Underwater Distro Connection", "Distribution Center: Spikey Tunnel Shinespark",  8680076, 305, lambda state: state.has("Gravity Suit", player) and state.has("Speed Booster", player)),  # grav + speed
        LocationData("Underwater Distro Connection", "Distribution Center: After Spikey Tunnel",  8680078, 306, lambda state: state.has("Power Bomb", player) and state.has("Speed Booster", player) and state.has("Gravity Suit", player) and state.has("Space Jump", player)),  # speed + grav + space + pb

        LocationData("Screw Attack", "Distribution Center: Screw Attack", 8680080, 8),
        LocationData("Pipe Hell Outside", "Distribution Center: Outside after Gravity", 8680081, 302, lambda state: state.has("Power Bomb", player) and state.has("Space Jump", player) and state.has("Gravity Suit", player)),  # pb + space + grav
        LocationData("Pipe Hell R", "Distribution Center: Before Underwater Pipe", 8680082, 301, lambda state: state.has("Power Bomb", player) and state.has("Speed Booster", player)),  # pb + speed
        ...
        LocationData("Gravity", "Distribution Center: Gravity", 8680084, 9, logic.AM2R_can_bomb),  # can bomb
        ...
        LocationData("Deep Caves", "Deep Caves: Ball Spark",  8680086, 56, lambda state: state.has("Gravity Suit", player) and logic.AM2R_has_ballspark(state)),
        LocationData("Deep Caves", "Deep Caves: Behind the Bomb Block",  8680087, 60, logic.AM2R_can_bomb),
        ...
        LocationData("Golden Temple", "Golden Temple: Metroid above Spider Ball", 8680101, 311, logic.AM2R_can_spider),
        ...
        LocationData("Hydro Nest", "Hydro Nest: Spiderman Decent", 8680109, 319),
        ...
        LocationData("Industrial Complex", "Inside Industrial: Rawsome1234 by the Lava", 8680122, 325, lambda state: state.has("Speed Booster", player) and logic.AM2R_can_bomb(state)),
        ...
        LocationData("The Tower", "The Tower: Variable \"GUH\"", 8680128, 338, logic.AM2R_can_fly),  # ANX
        LocationData("The Tower", "Ruler of The Tower: Slagathor", 8680129, 340, logic.AM2R_can_schmove),  # Rawsome
        LocationData("The Tower", "The Tower: Anakin", 8680130, 339, logic.AM2R_can_bomb),  # Xander
        LocationData("The Tower", "The Tower: Mr.Sandman", 8680131, 341, logic.AM2R_can_fly),  # Xander
        LocationData("The Tower", "The Tower: Xander", 8680132, 342, lambda state: state.has("Space Jump", player)),

        LocationData("EMP", "EMP: Sir Zeta Commander of the Alpha Squadron", 8680133, 343, logic.AM2R_can_bomb),  # Lucina
        ...
        LocationData("Deep Caves", "Deep Caves: Little Bro", 8680141, 351),
